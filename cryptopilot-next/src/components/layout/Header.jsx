...
function Header() {
  ...
  return (
    <header
      ref={headerRef}
      className="w-full bg-white dark:bg-[#0B0D12] border-b border-gray-200 dark:border-[#1C1F26] transition-colors duration-300 sticky top-0 z-50"
    >
                    ...
                    <>
                      ...
                      <div className="flex flex-col">
                        <span className="font-semibold text-sm">
                          {authMethod === "metamask" ? "MetaMask" : "Phantom"}
                        </span>
