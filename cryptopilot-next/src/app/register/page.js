        ...
        <form className="space-y-5" onSubmit={handleRegister}>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                placeholder="••••••••"
                className="w-full px-4 py-3 pr-12 bg-gray-50 dark:bg-[#0B0D12]/50 border border-gray-200 dark:border-gray-800 rounded-xl text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-600 focus:outline-none focus:border-[#D4AF37]/50 focus:ring-1 focus:ring-[#D4AF37]/50 font-medium"
                required
              />
              <button
                type="button"
          ...
          <div className="flex items-start pt-1">
            ...
            <label className="text-xs text-gray-500 dark:text-gray-400">
              J'accepte les{" "}
              <a href="#" className="text-[#D4AF37] hover:text-[#F5D76E]">
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-[#D4AF37] to-[#B4941F] text-[#0B0D12] font-bold py-3.5 rounded-xl hover:shadow-[0_0_20px_rgba(212,175,55,0.3)] shadow-lg mt-2"
          >
            Créer mon compte
          </button>
        </form>
