...
export default function NotFound() {
  ...
  return (
    <div className="flex flex-col flex-1 items-center justify-center px-4 relative overflow-hidden min-h-screen bg-gray-50 dark:bg-[#0B0D12]">
      {/* Background decoratif */}
      <div className="absolute inset-0 opacity-[0.03] dark:opacity-[0.02] pointer-events-none">
        <div className="absolute top-20 left-20 text-9xl font-bold text-[#D4AF37]">
          404
        </div>
        <div className="absolute bottom-20 right-20 text-9xl font-bold text-[#F5D76E]">
          404
        </div>
      </div>
