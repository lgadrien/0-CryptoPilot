...
function Register() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-[#0B0D12] px-4 py-12 transition-colors duration-300">
      <div className="w-full max-w-md bg-white dark:bg-[#1C1F26] rounded-2xl shadow-2xl shadow-gray-200/50 dark:shadow-yellow-900/10 p-8 transition-colors duration-300">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-[#D4AF37] mb-2">Inscription</h2>
          <p className="text-gray-600 dark:text-gray-400">Créez votre compte CryptoPilot</p>
        </div>
        ...
        <form className="space-y-5">
          ...
          <div className="flex items-start text-sm">
            <input
              type="checkbox"
              className="mr-2 mt-1 accent-[#D4AF37]"
              required
            />
